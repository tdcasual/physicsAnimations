...
describe('usePagedAdminList', () => {
  ...
  describe('applyPageResult', () => {
    ...
    it('应正确应用分页结果（追加模式）', () => {
      ...
      // 第一页
      applyPageResult(
        { items: [{ id: '1', name: 'Item 1' }], page: 1, total: 3 },
        { reset: true }
      )
      
      // 第二页（追加）
      applyPageResult(
        { items: [{ id: '2', name: 'Item 2' }], page: 2, total: 3 },
        { reset: false }
      )
  ...
  describe('resetList', () => {
    it('应重置所有状态', () => {
      ...
      // 先加载一些数据
      applyPageResult(
        { items: [{ id: '1', name: 'Item' }], page: 3, total: 100 },
        { reset: false }
      )
  ...
  describe('边界情况', () => {
    ...
    it('应处理字符串类型的数字字段', () => {
      ...
      applyPageResult(
        { items: [], page: '5' as any, total: '100' as any },
        { reset: true }
      )
