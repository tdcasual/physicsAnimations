...
export function useEmbedProfileCreateActions({ deps, reloadEmbedProfiles }: UseEmbedProfileCreateActionsArgs) {
  async function createEmbedProfileEntry() {
    deps.clearFieldErrors("createEmbedProfileName", "createEmbedScriptUrl", "createEmbedDefaultOptionsJson");
