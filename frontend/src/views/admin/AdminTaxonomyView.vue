  ...
  <section class="admin-taxonomy-view">
    ...
    <section class="taxonomy-mobile-actions admin-card">
      ...
      <button
        ...
        :disabled="!selection && !isMobileEditorSheetOpen"
    ...
    <div class="admin-workspace-grid admin-workspace-grid--balanced">
      ...
      <div
        :class="[
          ...
          { 'is-open': isMobileEditorSheetOpen },
        ]"
      >
        <div
          ref="editorTopRef"
          class="taxonomy-mobile-editor-top taxonomy-mobile-focus-anchor"
          aria-hidden="true"
        />
        <div class="taxonomy-editor-sheet-header">
          <div class="taxonomy-editor-sheet-copy">
            ...
            <strong>{{
              activeMobileEditorSheet === 'create-group' ? '新建大类' : '节点编辑'
            }}</strong>
          </div>
        ...
        <div
          ...
          class="taxonomy-mobile-focus-anchor"
        >
          <CategoryEditorPanel
            class="admin-card"
            :saving="saving"
