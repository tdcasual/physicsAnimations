...
const activeGroup = computed(() => 
  groups.value.find(g => g.id === view.value.activeGroupId)
)
    ...
    <template v-else>
      ...
      <div class="catalog-content">
        <PEmpty
          ...
          description="暂无符合条件的演示"
          size="lg"
        >
          <template #action>
            <button class="clear-btn" @click="searchQuery = ''; selectCategory('all')">
              清除筛选
            </button>
          </template>
        </PEmpty>
