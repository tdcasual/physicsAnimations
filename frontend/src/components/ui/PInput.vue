...
.p-input-container--sm { height: 32px; padding: 0 var(--space-3); font-size: var(--text-sm); }
.p-input-container--md { height: 40px; padding: 0 var(--space-3); font-size: var(--text-base); }
.p-input-container--lg { height: 48px; padding: 0 var(--space-4); font-size: var(--text-md); }
