    ...
    <div class="catalog-workbench-head">
      ...
      >
        <span class="catalog-workbench-summary-copy">
          <strong>{{ workbenchSummary.totalCount ? `${workbenchSummary.totalCount} 条教学线索` : "先开始浏览演示" }}</strong>
          <span>最近 {{ workbenchSummary.recentCount }} · 收藏 {{ workbenchSummary.favoriteCount }}</span>
        </span>
